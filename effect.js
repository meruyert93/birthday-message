...
$('document').ready(function(){
		...
		$(window).resize(function(){
			 vw = $(window).width()/2;
			$('#b1,#b2,#b3,#b4').stop();
			$('#b11').animate({top:300, left: vw-150},500);
			$('#b22').animate({top:300, left: vw-100},500);
			$('#b33').animate({top:300, left: vw+50},500);
			$('#b44').animate({top:300, left: vw+150},500);
	...
	$('#wish_message').click(function(){
        ...
        $('#b7').attr('id','b77')
        $('#b8').attr('id','b88')
		$('#b11').animate({top:150, left: vw-180},500);
		$('#b22').animate({top:150, left: vw-80},500);
		$('#b33').animate({top:150, left: vw+10},500);
		$('#b44').animate({top:150, left: vw+70},500);
		// $('#b55').animate({top:150, left: vw+100},500);
